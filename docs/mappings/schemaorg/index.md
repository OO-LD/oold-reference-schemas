...
How the terms of this library are named in schema.org.
...
counterpart in schema.org, with the ontology version the mapping was checked against.

{{ download("/mappings/schemaorg.sssom.tsv", "SSSOM TSV") }}

{{ sssom_table("schemaorg") }}

## Derived crosswalks

What schema.org and another vocabulary call the same thing, chained through the terms both map
